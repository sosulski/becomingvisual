...
#CONCAT
#presaly = presalnames + rankpresal
...
#workswell for sorting, put recarray column calls can't be done
#data1 = sorted(data, key=lambda presalary: presalary[4])
#print(data1)
